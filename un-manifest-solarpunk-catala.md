...
<head>
	...
	<link rel="profile" href="http://gmpg.org/xfn/11">
		<title>Un Manifest Solarpunk (Catal&agrave;) &ndash; ReDes &ndash; Regenerative Design</title>
...
<link rel="https://api.w.org/" href="/wp-json/"><link rel="alternate" title="JSON" type="application/json" href="/wp-json/wp/v2/pages/844"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="/xmlrpc.php?rsd">
<meta name="generator" content="WordPress 6.8.2">
<meta name="generator" content="WooCommerce 7.2.2">
<link rel="canonical" href="/es/un-manifest-solarpunk-catala/">
<link rel="shortlink" href="/?p=844">
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fes%2Fun-manifest-solarpunk-catala%2F">
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fes%2Fun-manifest-solarpunk-catala%2F&amp;format=xml">
...
<body class="wp-singular page-template-default page page-id-844 wp-custom-logo wp-theme-neve theme-neve woocommerce-no-js  nv-sidebar-right menu_sidebar_slide_left" id="neve_body">
<div class="wrapper">
...
<ul class="sub-menu">
	<li id="menu-item-1725-es" class="lang-item lang-item-78 lang-item-es current-lang lang-item-first menu-item menu-item-type-custom menu-item-object-custom menu-item-1725-es"><a href="/es/un-manifest-solarpunk-catala/" hreflang="es-ES" lang="es-ES"><img src="data:image/png;base64," alt="Espa&ntilde;ol" width="16" height="11" style="width: 16px; height: 11px;"><span style="margin-left:0.3em;">Espa&ntilde;ol</span></a></li>
...
<div class="container single-page-container">
	...
	<div class="nv-page-title ">
				<h1>Un Manifest Solarpunk (Catal&agrave;)</h1>
					</div><!--.nv-page-title-->
...
<p> <em>Tradu&iuml;t per Mia Igual Aguilar i Alessandro Ardovini</em></p>
...
<div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
<div class="wp-block-button alignright"><a class="wp-block-button__link has-background has-neve-button-color-background-color" href="/un-manifiesto-solarpunk-todos-los-idiomas/"> altres idiomes</a></div>
</div>
</div>



<p>Durant els &uacute;ltims deu anys, o m&eacute;s, moltes persones han escrit sobre solarpunk. Sobretot despr&eacute;s de 2014.</p>



<p>No obstant aix&ograve; el g&egrave;nere no est&agrave; clarament definit encara.</p>



<p>Aquest Manifest Solarpunk &eacute;s una re-adaptaci&oacute; creativa d&rsquo;idees sobre solarpunk escrites per moltes persones. Aquestes idees es poden trobar principalment en <em>Solarpunk: a reference guide</em> que es troba <a href="https://medium.com/solarpunks/solarpunk-a-reference-guide-8bcf18871965">aqu&iacute;</a> i a <em>Solarpunk: Notes towards a Manifesto d&rsquo;Adam Flynn</em>, que es troba <a href="https://hieroglyph.asu.edu/2014/09/solarpunk-notes-toward-a-manifesto/">aqu&iacute;</a>.</p>



<h2 id="kt-adv-heading_a6bf17-ca" class="kt-adv-heading_a6bf17-ca wp-block-kadence-advancedheading">Un Manifest Solarpunk</h2>



<p>El solarpunk &eacute;s un moviment de ficci&oacute; especulativa, art, moda i activisme que intenta respondre i encarnar la pregunta &laquo;com seria una civilitzaci&oacute; sostenible i com podem arribar-hi?&raquo;</p>



<p>L&rsquo;est&egrave;tica de solarpunk vincula el pr&agrave;ctic amb lo bell, lo ben dissenyat amb el verd i lo exuberant, el brillant i lo acolorit amb lo senzill i s&ograve;lid.</p>



<p>El solarpunk pot ser ut&ograve;pic, simplement optimista, destinat a crear un m&oacute;n millor, per&ograve; mai &eacute;s dist&ograve;pic. A mesura que el nostre m&oacute;n es posa m&eacute;s i m&eacute;s turbulent, el que necessitem s&oacute;n solucions, no nom&eacute;s advert&egrave;ncies. Solucions per prosperar sense combustibles f&ograve;ssils. Per administrar justament l&rsquo;escassetat real i compartir generosament en lloc d&rsquo;alimentar una falsa escassetat i una falsa abund&agrave;ncia. Per ser m&eacute;s afectu&oacute;s entre nosaltres i amb el planeta que compartim.</p>



<p>El solarpunk &eacute;s al mateix temps una visi&oacute; del futur, una provocaci&oacute; reflexiva, una forma de vida i un conjunt de propostes realistes per aconseguir aquest futur.<br></p>



<ol class="wp-block-list"><li>Som solarpunk perqu&egrave; ens han pres l&rsquo;optimisme i estem intentant recuperar-lo.</li><li>Som solarpunk perqu&egrave; les &uacute;niques opcions s&oacute;n el denialisme o la desesperaci&oacute;.</li><li>En el seu nucli, el solarpunk &eacute;s una visi&oacute; d&rsquo;un futur que encarna el millor que la humanitat pot aconseguir: una postescassetat, un m&oacute;n postjer&agrave;rquic i postcapitalista on la humanitat es veu com a part de la natura i les energies netes reemplacen els combustibles f&ograve;ssils.</li><li>El &laquo;punk&raquo;, en solarpunk t&eacute; a veure amb la rebel&middot;li&oacute;, la contracultura, el postcapitalisme, el decolonialisme i l&rsquo;entusiasme. T&eacute; a veure amb anar en una direcci&oacute; diferent a la convencional, que &eacute;s cada vegada m&eacute;s alarmant.</li><li>El solarpunk &eacute;s tant un moviment com un g&egrave;nere: no es tracta nom&eacute;s d&rsquo;hist&ograve;ries, sin&oacute; tamb&eacute; de com materialitzar-les.</li><li>El solarpunk abasta multitud de t&agrave;ctiques: no hi ha cap manera correcta de fer solarpunk. De fet, diferents comunitats de tot el m&oacute;n abracen el nom i les idees i construir n&iacute;nxols de revoluci&oacute; autosostenible.</li><li>El solarpunk ens proporciona una nova perspectiva valuosa, un paradigma i un vocabulari per descriure un possible futur. En lloc d&rsquo;abra&ccedil;ar el retrofuturisme, el solarpunk posa la mirada completament en el futur. No un futur alternatiu, sin&oacute; un futur possible.</li><li>El nostre futurisme no &eacute;s nihilista com el de cyberpunk i evita les tend&egrave;ncies potencialment reaccion&agrave;ries de steampunk: t&eacute; a veure amb l&rsquo;enginy, la generativitat, la independ&egrave;ncia i la comunitat.</li><li>El solarpunk emfasitza la sostenibilitat mediambiental i la just&iacute;cia social.</li><li>El solarpunk tracta de trobar maneres de fer la nostra vida m&eacute;s meravellosa ara mateix i tamb&eacute; la de les generacions que ens seguiran.</li><li>El nostre futur significa tornar a utilitzar el que ja tenim i, si cal, transformar-lo per donar-li un altre &uacute;s. Imagina desfer-se de les &laquo;ciutats intel&middot;ligents&raquo; per una ciutadania intel&middot;ligent.</li><li>El solarpunk reconeix la influ&egrave;ncia hist&ograve;rica que la pol&iacute;tica i la ci&egrave;ncia ficci&oacute; han tingut l&rsquo;una amb l&rsquo;altra.</li><li>El solarpunk reconeix la ci&egrave;ncia ficci&oacute; no nom&eacute;s com a mer entreteniment, sin&oacute; tamb&eacute; com una forma d&rsquo;activisme.</li><li>El solarpunk vol oposar-se als escenaris d&rsquo;una terra moribunda, una difer&egrave;ncia insuperable entre els rics i els pobres, i una societat controlada per les corporacions. No en centenars d&rsquo;anys, ara.</li><li>El solarpunk t&eacute; a veure amb la cultura &ldquo;maker&rdquo; de la joventut, les solucions energ&egrave;tiques locals i les xarxes, les maneres de crear sistemes aut&ograve;noms que funcionen. T&eacute; a veure amb estimar el m&oacute;n.</li><li>La cultura solarpunk inclou totes les cultures, religions, habilitats, sexes, g&egrave;neres i identitats sexuals.</li><li>El solarpunk &eacute;s la idea d&rsquo;una humanitat que assoleix una evoluci&oacute; social que abasta no nom&eacute;s la mera toler&agrave;ncia, sin&oacute; una compassi&oacute; i una acceptaci&oacute; m&eacute;s completes.</li><li>L&rsquo;est&egrave;tica visual de solarpunk est&agrave; oberta i evolucionant. Ara &eacute;s una combinaci&oacute; de:<ol><li>Era de la navegaci&oacute; a vela i del mite de la frontera vuitcentista (per&ograve; amb m&eacute;s bicicletes)</li><li>Reutilitzaci&oacute; creativa de la infraestructura existent (de vegades post-apocal&iacute;ptica, de vegades contempor&agrave;nia-estramb&ograve;tica)</li><li>Tecnologia apropiada</li><li>Modernisme</li><li>Hayao Miyazaki</li><li>Innovacions d&rsquo;estil jugaard des de pa&iuml;sos no occidentals</li><li>Back-ends d&rsquo;alta tecnologia amb resultats senzills i elegants</li></ol></li><li>Els ambients constru&iuml;ts de solarpunk s&rsquo;inspiren en els principis de nou urbanisme o nou pedestrianisme, i en la sostenibilitat mediambiental.</li><li>El solarpunk concep un entorn constru&iuml;t adaptat creativament per, entre altres coses, aprofitar el guany solar utilitzant diferents tecnologies. L&rsquo;objectiu &eacute;s promoure l&rsquo;autosufici&egrave;ncia i la vida dins dels l&iacute;mits naturals.</li><li>En el solarpunk ens hem aturat just a temps per a frenar la lenta destrucci&oacute; del nostre planeta. Hem apr&egrave;s a utilitzar la ci&egrave;ncia s&agrave;viament per millorar les nostres condicions de vida com a part del nostre planeta. Ja no som caps suprems. Som cuidadores. Som jardineres.</li><li>El solarpunk:<ol><li>&eacute;s divers</li><li>t&eacute; espai per a la conviv&egrave;ncia de l&rsquo;espiritualitat i la ci&egrave;ncia</li><li>&eacute;s bonic</li><li>pot succeir. Ara</li></ol></li></ol>



<p><em>La Comunitat Solarpunk</em></p>



<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img decoding="async" alt="Llic&egrave;ncia de Creative Commons" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png"></a><br>Aquesta obra est&agrave; subjecta a una llic&egrave;ncia de <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Reconeixement-CompartirIgual 4.0 Internacional de Creative Commons</a>
</div>		</div>
			</div>
</div>
...
/* <![CDATA[ */
var wpdata = {"object_id":"844","site_url":""};
/* ]]> */
</script>
