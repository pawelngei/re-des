...
<head>
	...
	<link rel="profile" href="http://gmpg.org/xfn/11">
		<title>Ein Solarpunk-Manifest (Deutsch) &ndash; ReDes &ndash; Regenerative Design</title>
...
<link rel="canonical" href="/es/ein-solarpunk-manifest-deutsch/">
<link rel="shortlink" href="/?p=1217">
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fes%2Fein-solarpunk-manifest-deutsch%2F">
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="/wp-json/oembed/1.0/embed?url=https%3A%2F%2F%2Fes%2Fein-solarpunk-manifest-deutsch%2F&amp;format=xml">
...
<body class="wp-singular page-template-default page page-id-1217 wp-custom-logo wp-theme-neve theme-neve woocommerce-no-js  nv-sidebar-right menu_sidebar_slide_left" id="neve_body">
<div class="wrapper">
...
<ul class="sub-menu">
	<li id="menu-item-1725-es" class="lang-item lang-item-78 lang-item-es current-lang lang-item-first menu-item menu-item-type-custom menu-item-object-custom menu-item-1725-es"><a href="/es/ein-solarpunk-manifest-deutsch/" hreflang="es-ES" lang="es-ES"><img src="data:image/png;base64," alt="Espa&ntilde;ol" width="16" height="11" style="width: 16px; height: 11px;"><span style="margin-left:0.3em;">Espa&ntilde;ol</span></a></li>
...
<div class="container single-page-container">
	...
	<div class="nv-page-title ">
				<h1>Ein Solarpunk-Manifest (Deutsch)</h1>
					</div><!--.nv-page-title-->
...
<p><em>&Uuml;bersetzt von Martin Schweizer</em> <em>und Martin Ponweiser</em></p>
</div>



<div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
<div class="wp-block-button alignright"><a class="wp-block-button__link has-white-color has-neve-button-color-background-color has-text-color has-background" href="/un-manifiesto-solarpunk-todos-los-idiomas/">other languages</a></div>
...
<p>Viele Leute haben in den letzten 10+ Jahren &uuml;ber Solarpunk geschrieben. Meistens nach 2014.</p>



<p>Das Genre ist noch nicht klar definiert.</p>



<p>Dieses Solarpunk-Manifest ist eine von vielen Menschen verfasste kreative Neuanpassung von Ideen &uuml;ber Solarpunk. Diese Ideen finden sich haupts&auml;chlich in: &bdquo;Solarpunk: a reference guide&ldquo;, das <a href="https://medium.com/solarpunks/solarpunk-a-reference-guide-8bcf18871965">hier</a> zu finden ist, und in &bdquo;Solarpunk: Notes towards a Manifesto&ldquo; von Adam Flynn, das <a href="https://hieroglyph.asu.edu/2014/09/solarpunk-notes-toward-a-manifesto/">hier</a> zu finden ist.</p>



<h2 id="kt-adv-heading_a6bf17-ca" class="kt-adv-heading_a6bf17-ca wp-block-kadence-advancedheading">Ein Solarpunk-Manifest</h2>



<p>Solarpunk ist eine Bewegung der vision&auml;ren Ideen in Kunst, Mode und Aktivismus, die die Frage zu beantworten versucht, wie eine nachhaltige Zivilisation aussehen kann, und wie man dies erreichen k&ouml;nnte.</p>



<p>Die &Auml;sthetik von Solarpunk verbindet das Praktische mit dem Sch&ouml;nen, das Wohldurchdachte mit dem Gr&uuml;nen und &Uuml;ppigen, das Helle und Bunte mit dem Erdigen und Soliden.</p>



<p>Solarpunk kann utopisch, einfach nur optimistisch, oder mit den K&auml;mpfen auf dem Weg zu einer besseren Welt besch&auml;ftigt sein. Solarpunk ist aber niemals dystopisch. Da unsere Welt vor Ungl&uuml;ck brodelt, brauchen wir L&ouml;sungen, nicht nur Warnungen.</p>



<p>Wir brauchen L&ouml;sungen, um ohne fossile Brennstoffe zu gedeihen, mit echter Knappheit gerecht umzugehen und an der schon jetzt vorhandenen F&uuml;lle teilzuhaben. Statt eine falsche Knappheit oder einen falschen &Uuml;berfluss zu unterst&uuml;tzen, m&ouml;chten wir freundlicher zueinander und zu dem Planeten zu sein, den wir uns teilen.</p>



<p>Solarpunk ist gleichzeitig eine Vision der Zukunft, eine durchdachte Provokation, eine Lebensweise und eine Reihe von erreichbaren Vorschl&auml;gen, um dorthin zu gelangen.</p>



<ol class="wp-block-list"><li>Wir sind Solarpunks, weil uns der Optimismus genommen wurde, und wir versuchen, ihn wiederzuerlangen.</li><li>Wir sind Solarpunks, weil die einzigen anderen Optionen Verleugnung oder Verzweiflung w&auml;ren.</li><li>Im Kern ist Solarpunk eine Zukunftsvision, die das Beste verk&ouml;rpert, was die Menschheit erreichen kann: Eine post-knappe, posthierarchische, postkapitalistische Welt, in der sich die Menschheit als Teil der Natur versteht, und wo saubere Energie fossile Brennstoffe ersetzt.</li><li>Beim &bdquo;Punk&ldquo; im Solarpunk geht es um Rebellion, Gegenkultur, Postkapitalismus, Dekolonialismus und Begeisterung. Es geht darum, in eine andere Richtung zu gehen als der Mainstream, der immer mehr in eine f&uuml;r uns be&auml;ngstigende Richtung abdriftet.</li><li>Solarpunk ist ebenso eine Bewegung wie ein Genre: Es geht nicht nur um die Geschichten und Visionen, sondern auch darum, wie wir dorthin gelangen k&ouml;nnen.</li><li>Solarpunk verfolgt eine Vielzahl von Taktiken: Es gibt keinen einzigen richtigen Weg, um Solarpunk zu machen. Stattdessen &uuml;bernehmen verschiedene Gemeinschaften aus der ganzen Welt den Namen und die Ideen, und bauen kleine Nester der sich selbst vorantragenden Revolution.</li><li>Solarpunk bietet eine wertvolle neue Perspektive, ein Paradigma und ein Vokabular, um eine m&ouml;gliche Zukunft zu beschreiben. Anstatt Retrofuturismus zu glorifizieren, blickt Solarpunk vollst&auml;ndig in die Zukunft. Keine alternative Zukunft, sondern eine m&ouml;gliche Zukunft.</li><li>Unser Futurismus ist nicht nihilistisch wie Cyberpunk, und vermeidet die potenziell quasi-reaktion&auml;ren Tendenzen von Steampunk: Es geht um Einfallsreichtum, Generativit&auml;t, Unabh&auml;ngigkeit und Gemeinschaft.</li><li>Solarpunk betont &ouml;kologische Nachhaltigkeit und soziale Gerechtigkeit.</li><li>Bei Solarpunk geht es darum, Wege zu finden, das Leben f&uuml;r uns jetzt und auch f&uuml;r die Generationen, die uns folgen, sch&ouml;ner zu machen.</li><li>Unsere Zukunft muss die Umnutzung und Schaffung neuer Dinge aus dem, was wir bereits haben, beinhalten.</li><li>Solarpunk erkennt den historischen Einfluss an, den Politik und Science-Fiction aufeinander hatten.</li><li>Solarpunk erkennt Science-Fiction nicht nur als Unterhaltung, sondern als eine Form des Aktivismus.</li><li>Solarpunk will den Szenarien einer sterbenden Erde, einer un&uuml;berwindlichen Kluft zwischen Arm und Reich, und einer von Konzernen kontrollierten Gesellschaft entgegentreten. Nicht in Hunderten von Jahren, sondern in einer nahen bis mittleren Zukunft.</li><li>Solarpunk ist Teil einer jungen &bdquo;Maker-Kultur&ldquo; mit dem Ziel, lokale L&ouml;sungen, lokale Energienetze, und unterschiedliche Auspr&auml;gungen autonom funktionierender Systeme zu schaffen. Es geht darum, die Welt zu lieben.</li><li>Die Solarpunk-Kultur umfasst alle Kulturen, Religionen, F&auml;higkeiten, Geschlechter, Gender und sexuelle Identit&auml;ten.</li><li>Solarpunk ist die Idee, dass die Menschheit eine soziale Evolution erreicht hat, die nicht nur blo&szlig;e Toleranz umfasst, sondern auch ein umfassenderes Mitgef&uuml;hl und Akzeptanz.</li><li>Die visuelle &Auml;sthetik von Solarpunk ist offen und entwickelt sich weiter. Zur Zeit ist es ein Mash-up aus Folgendem:<ol><li>Gro&szlig;e Segelschiffe und das Pionierleben im 19. Jahrhundert (aber mit mehr Fahrr&auml;dern)</li><li>Kreative Wiederverwendung bestehender Infrastruktur (mal postapokalyptisch, mal zeitgen&ouml;ssisch-entfremdet)</li><li>Angepasste Technologie</li><li>Jugendstil</li><li>Hayao Miyazaki</li><li>Innovation im Jugaad-Stil aus der nicht-westlichen Welt</li><li>Hightech-Backends mit einfachen, eleganten Outputs</li></ol></li><li>Solarpunk spielt in einer Zukunft, die nach den Prinzipien des New Urbanism oder New Pedestrianism und der &ouml;kologischen Nachhaltigkeit gebaut wurde.</li><li>Solarpunk stellt sich eine gebaute Umgebung vor, die unter anderem unter Verwendung verschiedener Technologien kreativ f&uuml;r den Solargewinn angepasst wurde. Ziel ist die F&ouml;rderung der Selbstversorgung und des Lebens innerhalb der nat&uuml;rlichen Gegebenheiten.</li><li>In Solarpunk haben wir uns gerade rechtzeitig zur&uuml;ckgezogen, um die langsame Zerst&ouml;rung unseres Planeten zu stoppen. Wir haben gelernt, die Wissenschaft mit Bedacht einzusetzen, um unsere Lebensbedingungen als Teil unseres Planeten zu verbessern. Wir sind keine Feudalherren mehr. Wir sind die H&uuml;ter und H&uuml;terinnen. Wir sind die G&auml;rtner und G&auml;rtnerinnen.</li><li>Solarpunk:<ol><li>ist vielf&auml;ltig</li><li>l&auml;sst Raum f&uuml;r die Koexistenz von Spiritualit&auml;t und Wissenschaft</li><li>ist sch&ouml;n</li><li>kann stattfinden. Jetzt</li></ol></li></ol>



<p> <em>Die Solarpunk-Community</em></p>



<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img decoding="async" alt="Creative Commons Lizenzvertrag" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png"></a><br>Dieses Werk ist lizenziert unter einer <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Namensnennung &ndash; Weitergabe unter gleichen Bedingungen 4.0 International Lizenz</a>.
</div>		</div>
			</div>
</div>
...
/* <![CDATA[ */
var wpdata = {"object_id":"1217","site_url":""};
/* ]]> */
</script>
